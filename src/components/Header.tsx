              ...
              <div className="flex items-center">
                <Link to="/" className="flex items-center focus-ring rounded-md">
                  <img
                    ...
                    onError={(e) => {
                      e.currentTarget.src = 'data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"%3E%3Crect fill="%2300a859" width="100" height="100"/%3E%3Ctext x="50" y="55" font-size="40" fill="white" text-anchor="middle" font-family="Arial, sans-serif" font-weight="bold"%3EA%3C/text%3E%3C/svg%3E';
                    }}
                  />
                </Link>
              </div>
